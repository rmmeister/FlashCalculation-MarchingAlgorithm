function [ x, y, nV, nL, gasMW, liqMW, mixtureMW ] = calcFlash( P, T )
%CALCFLASH Flash calculatons carried out for a specific Pressure and
%Temperature
%   Using Peng-Robinson EOS, and assuming a known composition Z, the gas
%   phase and liquid phase molar amounts and components are derived.
%   Pressure should be in MPa, and Temperature in Kelvin.
